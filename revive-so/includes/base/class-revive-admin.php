...
class REVIVESO_Admin extends REVIVESO_BaseController {
	...
	public function extensions_requirements() {
		...
		$all_extensions = ( is_null( $extensions['all_extensions'] )
							|| ! is_array( $extensions['all_extensions'] )
							)
				? array()
		...
		$default_extensions = array(
			'reviveso-pro' => array(
				'path'            => 'wp-reviveso-pro/reviveso-pro.php',
				'lite_dependency' => '2.0.0',
			),
		);
		$all_extensions     = array_merge( $all_extensions, $default_extensions );
	...
	public function extensions_notices() {
		$revive_page = self::is_reviveso_admin_page();
