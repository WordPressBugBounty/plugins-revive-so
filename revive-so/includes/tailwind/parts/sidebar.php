				...
				<ul role='list' class='flex flex-1 flex-col gap-y-3'>
					...
					foreach ( $tabs as $tab ) {
						...
						<li>
							<a href='
							<?php
							echo esc_url( admin_url( $link ) );
							?>
							' class='
							<?php
							echo esc_attr( $active . $upsell );
							?>
							hover:text-indigo-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold'>
								<?php
					...
					<li>
						...
						?>
						' class='hover:text-indigo-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold back-button'>
